...
def main(args):
    ...
    msg = args.input_text
    text_list = ['<s>後悔ばかりです。</s>', '<s>彼氏ができません。</s>', '<s>自分の恋愛運を信じれません。</s>', '<s>元カレに裏切られたのでこわいです。</s>', '<s>このまま諦めるのは嫌です。</s>', '<s>切なくて胸が避けそうです。</s>', '<s>ショックのあまり立ち直れないです。</s>', '<s>孤独になるのが怖い。</s>', '<s>就活の終わりが見えていない。</s>', '<s>意気消沈気味です。</s>', '<s>諦めた方がいいですか。</s>']
